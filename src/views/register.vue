  ...
  <main class="  min-h-screen  bg-gradient-to-r from-purple-100 via-purple-100 to-purple-100 relative overflow-hidden">
	...
	<div class=" py-3  sm:max-w-md sm:mx-auto absolute z-10 top-20 inset-x-0 ">
		...
		<div class="relative px-4 py-8 bg-white  shadow-lg sm:rounded-3xl sm:p-4">
            ...
            <div class="relative">
							<input   v-model="fullName" autocomplete="on" id="fullName" name=" fullName" type=" fullName" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="fullName" />
							<label for=" fullName" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"  >  Full Name  <span class=" font-extrabold text-lg  text-red-600">*</span></label>
						</div>
						<div class="relative">
							...
							<label for="email" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Email Address <span class="  font-extrabold text-lg  text-red-600">*</span> </label>
						</div>
						<div class="relative">
							...
							<label for="password" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Password <span class=" font-extrabold text-lg  text-red-600">*</span></label>
						</div>
						<div class="relative">
